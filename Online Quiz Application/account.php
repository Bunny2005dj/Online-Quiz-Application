      ...
      <td>
          <b>
              <a href="account.php?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '" 
                 class="pull-right btn sub1" 
                 style="margin:0px; background:rgba(51, 51, 51, 0.65); color:#28a745; border: 2px solid #28a745; transition: background-color 0.3s, color 0.3s, border-color 0.3s;"
                 onmouseover="this.style.backgroundColor=\'#28a745\'; this.style.color=\'white\'; this.style.borderColor=\'#28a745\';" 
                 onmouseout="this.style.backgroundColor=\'rgba(51, 51, 51, 0.65)\'; this.style.color=\'#28a745\'; this.style.borderColor=\'#28a745\';">
...
else
{
    echo '<tr style="color:#99cc32">
        ...
        <td>
            <b>
                <a href="update.php?q=quizre&step=25&eid=' . $eid . '&n=1&t=' . $total . '" 
                   class="pull-right btn sub1" 
                   style="margin:0px; background:rgba(51, 51, 51, 0.65); border: 2px solid #FF3131; color:#FF6666; transition: background-color 0.3s, color 0.3s;"
                   onmouseover="this.style.backgroundColor=\'#FF3131\'; this.style.color=\'white\';" 
                   onmouseout="this.style.backgroundColor=\'rgba(51, 51, 51, 0.65)\'; this.style.color=\'#FF6666\';">
...
$qns=$row['qns'];
$qid=$row['qid'];
echo '<b  class="ques">Question &nbsp;'.$sn.'&nbsp;::<br />'.$qns.'</b><br /><br />';
}
...
while ($row = mysqli_fetch_array($q)) {
  ...
  echo '<button type="submit" name="ans" value="' . $optionid . '" class="btn btn-option gptbutton">' . $option . '</button><br /><br />';
}
...
<center><h1 class="title" style="color:white">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
...
$r=$row['Correct'];
$qa=$row['level'];
echo '<tr style="color:white"><td>Total Questions</td><td>'.$qa.'</td></tr>
      <tr style="color:#99cc32"><td>right Answer&nbsp;<span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span></td><td>'.$r.'</td></tr> 
	  <tr style="color:red"><td>Wrong Answer&nbsp;<span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></td><td>'.$w.'</td></tr>
	  <tr style="color:white"><td>Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td>'.$s.'</td></tr>';
}
...
$c++;
echo '<tr><td><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$college.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h4 style="font-family:'typo';color:white ">akshithperakam@gmail.com</h4>
		<h4 style="font-family:'typo';color:white ">Sathyabama Institute of Science and Technology</h4></div></div>
		</p>
      </div>
